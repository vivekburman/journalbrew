...
userInfoRouter.delete('/draft/delete', jwtUtils_1.utils.verifyAccessToken, function (req_, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                db = new database_1.default();
                return [4 /*yield*/, db.exec(db.TYPES.DELETE, "DELETE FROM user_to_post \n                WHERE " + fields_1.ID + "=?\n                AND " + fields_1.AUTHOR_ID + "=?\n                AND " + fields_1.POST_ID + " IS NULL", [draftID, Buffer.from(uuid_1.parse(userID))])];
            case 3:
                response = _a.sent();
...
userInfoRouter.put('/add-bookmark', jwtUtils_1.utils.verifyAccessToken, function (req_, res, next) { return __awaiter(void 0, void 0, void 0, function () {
